...
const RegistrationForm = () => {
  ...
  setLoading(true);
    ...
    try { 
      ...
      const imageResponse = await axios.post('https://example.com/api/upload', formData);
      const imagePath = "https://example.com/" +      imageResponse.data.imagePath;

      
      const response = await axios.post('https://example.com/api/participant', {
        name,
        email,
        aboutme,
        organization,
